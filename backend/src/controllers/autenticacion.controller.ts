...
export class AutenticacionController{
    ...
    async registrar (req:Request,res:Response)
    {
        ...
        const token:string = jwt.sign({_id:resultado.insertId},process.env.TOKEN_SECRET || '1234567');
    ...
    async ingresar (req:Request,res:Response)
    {
        ...
        if(!usuario[0])
        {
            ...
            const correctPassword = bcrypt.compare(req.body.password, usuario[0].password);
            ...
            res.json('Contraseña incorrecta!');
                ...
                const token:string = jwt.sign({_id:usuario[0].id_usuario},process.env.TOKEN_SECRET || '1234567',{
                expiresIn:60*60*24 
                });
