...
class AutenticacionController {
    registrar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token = jsonwebtoken_1.default.sign({ _id: resultado.insertId }, process.env.TOKEN_SECRET || '1234567');
            res.json('token');
        });
    }
    ingresar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!usuario[0]) {
                ...
                const correctPassword = bcryptjs_1.default.compare(req.body.password, usuario[0].password);
                if (!correctPassword) {
                    res.json('Contraseña incorrecta!');
                }
                else {
                    const token = jsonwebtoken_1.default.sign({ _id: usuario[0].id_usuario }, process.env.TOKEN_SECRET || '1234567', {
                        expiresIn: 60 * 60 * 24
                    });
